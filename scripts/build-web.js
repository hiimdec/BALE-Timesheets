...
const ALLOW = [
  ...
  'articles/after-wrap-what-happens-to-your-timesheet.html',
  'articles/commercials-and-long-form-what-changes.html',
  // PWA / crawl metadata
  'manifest.json',
  'robots.txt',
  'sitemap.xml',
