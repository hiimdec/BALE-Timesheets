...
**Fresh session?** Read HANDOVER.md for the current release state (2026.13 (13) on `main`, tagged v2026.13 and on the web since 11 September 2026; the App Store build 2026.13 is the founder's to submit from the Xcode 27 GUI, and 2026.12 (12) stays live on the store until Apple approves it), the working disciplines in practice, and every parked item with context. MAINTENANCE.md holds the parked work; CALC_DECISIONS.md holds the calc rulings ledger.
## Build topology
