...
**Fresh session?** Read HANDOVER.md for the current release state (2026.12 (12) on `develop`; 2026.11 (11) live on the App Store), the working disciplines in practice, and every parked item with context. MAINTENANCE.md holds the parked work; CALC_DECISIONS.md holds the calc rulings ledger.
## Build topology
